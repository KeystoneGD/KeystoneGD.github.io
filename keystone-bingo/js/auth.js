...
const TOKEN = "palace-bingo-host-v1";
...
export const session = {
  open() { try { sessionStorage.setItem("palace.host", "1"); } catch (e) {} },
  isOpen() { try { return sessionStorage.getItem("palace.host") === "1"; } catch (e) { return false; } },
  close() { try { sessionStorage.removeItem("palace.host"); } catch (e) {} },
};
