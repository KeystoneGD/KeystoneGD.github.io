...
(function () {
  ...
  function defaults() {
    return {
      ...
      /* patron site / interactions */
      interact: {
        salesOpen: !!(CFG.interact && CFG.interact.salesOpenByDefault),
        shoutoutsOpen: !(CFG.interact && CFG.interact.shoutoutsOpen === false),
        photosOpen: !(CFG.interact && CFG.interact.photosOpen === false),
        showKind: 'Both'                 /* Shoutouts | Photos | Both */
      },
